...
<head>
  ...
  <title>Portfólio de Matheus Galvão</title>
...
<body>
  ...
  <header>
    <h1>Portfólio de Matheus Galvão</h1>
  ...
  <main>
    <section id="sobre">
      <h2>Sobre</h2>
      <figure>
        <img src="https://via.placeholder.com/240" alt="Retrato de Matheus sorrindo de frente.">
        <figcaption>Foto ilustrativa do perfil</figcaption>
      </figure>
      <p>
        Olá! Sou o Matheus e estou começando no desenvolvimento web.
  ...
  <footer>
    <small>&copy; 2025 Matheus Galvão. Todos os direitos reservados.</small>
  </footer>
